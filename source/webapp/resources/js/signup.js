...
function idError(){
    ...
    if(false === reg.test(id)){
        document.getElementById('idError').innerHTML="아이디 구성방법과 일치하지않습니다."
...
function openIdChk(){
    ...
    window.open("idcheck", "chkForm", "width=500, height=300, resizable = no, scrollbars = no");
}
function inputidChk(){
	 document.getElementById('idchk').value = "false";
}
function isError(){

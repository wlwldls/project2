...
<%@include file="../includes/header.jsp"%>
    ...
    <title>회원가입</title>
    <form id="allInfo" name="allInfo" action="${path}/member/signup" method="post">
        <div id="wrap">
            <div id="content1">
                <h1>회원가입</h1>
                <div id="path">
            ...
            <div id="content3">
                ...
                <div id="name">
                    ...
                    <input id="memberName" type="text" name="username">
                </div>
                <div id="id">
                    <div id="idlabel">
                        <p>아이디*</p>
                    </div>
                    <input id="memberId" type="text" name="userid" onchange="idError()" onkeydown="inputidChk()">
                    <label id="idError" for="memberId"></label>
                    <input type="button" id="idCheck" onclick="openIdChk()" value="중복확인">
